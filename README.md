...
Мои проекты на HTML / JAVASCRIPT :
...
Мои старые проекты на  JAVA:
 1. [REST API приложение - сервис для синхронизации цен с биржей](https://github.com/zweidmitr/testB) (Spring Boot, Spring Data JPA, PostgresSQL)
 ...
 3. [Web-приложение "Приватный форум"](https://github.com/zweidmitr/job4j_forum/) (Maven, Spring Boot, PostgresSQL, Spring Data)
